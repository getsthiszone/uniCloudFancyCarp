<template>
	<view v-if="show" class="uni-noticebar" :style="{ backgroundColor: backgroundColor }" @click="onClick">
		...
		<view v-if="showClose === true || showClose === 'true'" class="uni-noticebar-close" @click="close">
			...
			<text class="cuIcon-notification" :style="{color:color}" style="font-size: 24rpx;" ></text>
		</view>
		<view v-if="showIcon === true || showIcon === 'true'" class="uni-noticebar-icon">
			<!-- <uni-icons type="sound-filled" :color="color" size="14" /> -->
			<text class="cuIcon-notification" :style="{color:color}" style="font-size: 28rpx;" ></text>
		</view>
		<!-- #endif -->
		<!-- #ifndef MP-ALIPAY -->
		<uni-icons v-if="showClose === true || showClose === 'true'" class="uni-noticebar-close" type="closeempty" :color="color"
		 size="12" @click="close" />
		<uni-icons v-if="showIcon === true || showIcon === 'true'" class="uni-noticebar-icon" type="sound-filled" :color="color"
		 size="14" />
		<!-- #endif -->
