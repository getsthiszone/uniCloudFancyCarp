<template>
	<view class="uni-load-more" @click="onClick" style="display: flex; align-items: center; justify-content: center;padding: 20upx ; " >
		<!-- #ifdef APP-PLUS-NVUE -->
...
<style lang="scss" scoped>
	...
	.loding{
		animation: loading-android1 1s linear infinite;;
	}
	
	@keyframes loading-android1 {
		0%{
			transform: rotate(0deg);
		} 
		100%{
